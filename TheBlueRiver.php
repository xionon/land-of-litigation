...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"><link rel="stylesheet" type="text/css" href="style.css" /><title>Adventure in The Blue River</title>
</head>
<body>
<?php
    if ($localuser->get_CurrentHP() > 0) echo $localadventure->showAdventure();
    else echo "<h1>You die!</h1>";
    echo $msg['message'];
    echo $msg['response'];
    echo "<br/>" . $commands;
?>
